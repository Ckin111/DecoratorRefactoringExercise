...
public class SpaceShipGameTest {
    ...
    public void createSpaceShip() {
        ...
        SpaceShipInterface ship = new SpaceShip(name);
    ...
    public void deductHitPointsSpaceShip() {
        SpaceShipInterface ship = new SpaceShip("The Black Pearl");
    ...
    public void isDestroyedSpaceShip() {
        SpaceShipInterface ship = new SpaceShip("The Death Star");
    ...
    public void underAttackSpaceShip() {
        SpaceShipInterface attacker = new SpaceShip("TIE Fighter");
        SpaceShipInterface attacked = new SpaceShip("X-Wing Fighter");
    ...
    public void createShieldedShip() {
        ...
        // MODIFY THE FOLLOWING LINE AS NEEDED TO CREATE A GUNSHIP
        SpaceShipInterface ship = new SpaceShip(name);
        ship = new ShieldedSpaceShip(ship);
    ...
    public void deductHitPointsShieldedShip() {
        ...
        SpaceShipInterface ship = new SpaceShip("Serenity");
        ship = new ShieldedSpaceShip(ship);
    ...
    public void createArmoredSpaceShip() {
        ...
        SpaceShipInterface ship = new SpaceShip(name);
        ship = new ArmoredSpaceShip(ship);
    ...
    public void deductHitPointsArmoredSpaceShip() {
        ...
        SpaceShipInterface ship = new SpaceShip("The Flying Dutchman");
        ship = new ArmoredSpaceShip(ship);
